            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="app-chat" role="tabpanel">
                    ...
                    <div class="list-group">
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Juan Sims</strong></a>
                                    <br />
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Maureen Jenkins</strong></a>
                                    <br />
                                    <small class="text-muted">Designeer</small>
                                </div>
                                <div class="ml-auto"><span class="circle bg-success circle-lg"></span></div>
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Billie Dunn</strong></a>
                                    <br />
                                    <small class="text-muted">Designeer</small>
                                </div>
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Tomothy Roberts</strong></a>
                                    <br />
                                    <small class="text-muted">Designeer</small>
                                </div>
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Lawrence Robinson</strong></a>
                                    <br />
                                    <small class="text-muted">Designeer</small>
                                </div>
                                <div class="ml-auto"><span class="circle bg-warning circle-lg"></span></div>
                        ...
                        <div class="list-group-item list-group-item-action border-0">
                            <div class="media">
                                ...
                                <div class="media-body text-truncate">
                                    <a href="#"><strong>Tyrone Owens</strong></a>
                                    <br />
                                    <small class="text-muted">Designeer</small>
                                </div>
                                <div class="ml-auto"><span class="circle bg-warning circle-lg"></span></div>
                    ...
                    <div class="px-3 py-4 text-center">
                        ...
                        <a class="btn btn-purple btn-sm" href="#" title="See more contacts"><strong>Load more..</strong></a>
                    </div>
                    <!-- Extra items-->
                    <div class="px-3 py-2">
